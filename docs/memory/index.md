...
所有配图采用深色背景（#1a1a2e）+ Claude Code Hust 橙蓝品牌色（#FF7A00）风格，与 Claude Code 官方文档一致。
...
- [Claude Code Hust 主页](/)
- [记忆系统源码](https://github.com/NanmiCoder/cc-hust/tree/main/src/memdir/)
- [自动提取服务](https://github.com/NanmiCoder/cc-hust/tree/main/src/services/extractMemories/)
- [AutoDream 服务](https://github.com/NanmiCoder/cc-hust/tree/main/src/services/autoDream/)
- [DreamTask 任务](https://github.com/NanmiCoder/cc-hust/tree/main/src/tasks/DreamTask/)
