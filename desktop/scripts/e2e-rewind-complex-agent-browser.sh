...
SESSION_NAME="cc-hust-rewind-complex-e2e-${RUN_ID}"
ARTIFACT_DIR="$(mktemp -d "/tmp/cc-hust-rewind-complex-e2e-${RUN_ID}-XXXX")"
...
${AB} open "${WEB_URL}"
${AB} wait 2000
${AB} eval "localStorage.setItem('cc-hust-locale', 'en'); location.reload();"
${AB} wait 2000
