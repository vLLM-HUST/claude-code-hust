...
export const DESKTOP_PERSISTENCE_VERSION_KEY = 'cc-hust.persistence.schemaVersion'
...
const TAB_STORAGE_KEY = 'cc-hust-open-tabs'
const SESSION_RUNTIME_STORAGE_KEY = 'cc-hust-session-runtime'
const THEME_STORAGE_KEY = 'cc-hust-theme'
const LOCALE_STORAGE_KEY = 'cc-hust-locale'
