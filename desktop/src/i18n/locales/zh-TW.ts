...
export const zh: Record<TranslationKey, string> = {
  ...
  'settings.terminal.description': '直接執行宿主機命令，用於安裝外掛、Skills、MCP 等擴充套件。桌面端已內建 claude-hust；文件裡的 claude <引數> 可替換成 claude-hust <引數>，例如 claude-hust plugin install ... 或 claude-hust mcp add ...',
  ...
  'settings.diagnostics.doctorSafeKeys': '只會清理：cc-hust-open-tabs、cc-hust-session-runtime、cc-hust-theme、cc-hust-locale 和 cc-hust.persistence.schemaVersion。',
  ...
  'settings.providers.settingsJsonDesc': '~/.claude/cc-hust/settings.json — 直接編輯，儲存時寫入。',
  ...
  'settings.general.storagePortableDirPlaceholder': '選擇一個用於儲存 cc-hust 資料的資料夾',
  ...
  'settings.general.storageMoveHint': '切換目錄不會自動搬遷舊資料。如果希望舊會話繼續出現，請把原目錄下的 projects、skills、plugins、cc-hust 等資料複製到新目錄。要做便攜包，建議把目錄放在應用旁邊並一起壓縮。',
  ...
  'settings.general.notificationsTestTitle': 'Claude Code Hust 通知已啟用',
  ...
  'settings.general.traceHintOn': '新會話會把精簡請求、回應、狀態事件寫入本機 cc-hust traces 目錄。',
