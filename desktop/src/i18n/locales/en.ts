export const en = {
  ...
  'settings.activity.defaultHandle': 'github.com/NanmiCoder/cc-hust',
  ...
  'settings.terminal.description': 'Run host-machine commands for plugin, skill, and MCP setup. The desktop app includes claude-hust; replace documented claude <args> with claude-hust <args>, for example: claude-hust plugin install ... or claude-hust mcp add ...',
  ...
  'settings.diagnostics.doctorSafeKeys': 'Clears only: cc-hust-open-tabs, cc-hust-session-runtime, cc-hust-theme, cc-hust-locale, and cc-hust.persistence.schemaVersion.',
  ...
  'settings.providers.settingsJsonDesc': '~/.claude/cc-hust/settings.json — edit directly, will be written on save.',
  ...
  'settings.general.storagePortableDirPlaceholder': 'Choose a folder for cc-hust data',
  ...
  'settings.general.storageMoveHint': 'Switching directories does not migrate existing data. Copy projects, skills, plugins, cc-hust, and related folders from the old directory if you want old sessions to keep appearing. For a portable bundle, keep this folder beside the app and zip them together.',
  ...
  'settings.general.notificationsTestTitle': 'Claude Code Hust notifications are enabled',
  ...
  'settings.general.traceHintOn': 'New sessions write compact requests, responses, and status events to the local cc-hust traces directory.',
