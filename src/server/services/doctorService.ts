  ...
  private async buildTargets(): Promise<DoctorTarget[]> {
    const targets: DoctorTarget[] = [
      ...
      this.jsonTarget(
        ...
        'Managed providers',
        'user',
        path.join(this.configDir, 'cc-hust', 'providers.json'),
      ),
      this.jsonTarget(
        'cc-hust-settings',
        'Managed provider settings',
        'user',
        path.join(this.configDir, 'cc-hust', 'settings.json'),
      ),
      ...
      this.jsonTarget('oauth', 'OAuth tokens', 'user', path.join(this.configDir, 'cc-hust', 'oauth.json')),
      this.jsonTarget(
        'openai-oauth',
        'OpenAI OAuth tokens',
        'user',
        path.join(this.configDir, 'cc-hust', 'openai-oauth.json'),
      ),
    ]
